...
from sklearn.preprocessing import OneHotEncoder # for onehot encoding part
...
class GenerativeModel(tf.keras.Model):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Conv2DT = partial(tf.keras.layers.Conv2DTranspose,kernel_size=(5,5), padding="same", strides=(2,2), use_bias=False)
    ...
    def call(self, inputs, labels):
        ...
        x = tf.add(x, self.conditional_dense(tf.one_hot(labels,depth=10)))
        x = self.reshape(x)
